...
if errorlevel 1 (
    ...
    set "REG_KEY_CHROME=HKCU\Software\Google\Chrome\NativeMessagingHosts\com.maxsdownloader.host"
    set "REG_KEY_EDGE=HKCU\Software\Microsoft\Edge\NativeMessagingHosts\com.maxsdownloader.host"
    set "REG_KEY_CHROMIUM=HKCU\Software\Chromium\NativeMessagingHosts\com.maxsdownloader.host"
    set "REG_KEY_MOZILLA=HKCU\Software\Mozilla\NativeMessagingHosts\com.maxsdownloader.host"
    set "FIREFOX_MANIFEST_PATH=%SCRIPT_DIR%com.maxsdownloader.host-firefox.json"
